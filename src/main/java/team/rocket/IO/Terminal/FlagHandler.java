...
/**
 * Largely based on
 * <a href="https://www.oodesign.com/chain-of-responsibility-pattern">OODesign Chain of Responsibility</a>. Intended to
 * be used as a base for other terminal flag handlers.
 *
 * @version 0.6.0
 * @since 0.3.0
 */
